"""
Django settings for auth_center project.
...
SECRET_KEY = "django-insecure-rh$wuylgtt%tey508pp_grjeu(1e_$g=p50*_%gxe6&q&u0dsf"
...
WSGI_APPLICATION = "auth_center.wsgi.application"
